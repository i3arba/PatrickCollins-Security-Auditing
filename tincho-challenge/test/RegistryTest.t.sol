...
contract RegistryTest is Test {
    ...
    function testStatelessFuzzCatchesTheBug(uint256 randomValue) public {
        //tincho used vm.assume, and not the conditional as I did.
        if(randomValue < registry.PRICE()) {
            return;
        }

        vm.deal(alice, randomValue);
        vm.startPrank(alice);
        registry.register{value: randomValue}();
